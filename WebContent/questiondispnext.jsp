...
<title>Insert title here</title>
    ...
    if(count>1)
    {
    	String coun=Integer.toString(count-1);
...
{	
		...
		if(c<=5)
			{
		document.f1.action="questiondispnext.jsp?sr="+total;
...
function goBack()
{
	...
	document.f1.action="questiondispprev.jsp?sr="+total;
	document.f1.method="post";
	document.f1.submit();
	return true;
